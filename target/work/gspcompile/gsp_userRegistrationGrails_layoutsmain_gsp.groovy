...
class gsp_userRegistrationGrails_layoutsmain_gsp extends GroovyPage {
...
createTagBody(2, {->
createTagBody(3, {->
invokeTag('layoutTitle','g',10,['default':("User Registration")],-1)
})
...
printHtmlPart(1)
invokeTag('javascript','asset',20,['src':("bootstrap-theme.min.js")],-1)
printHtmlPart(1)
...
public static final long LAST_MODIFIED = 1442826913000L
